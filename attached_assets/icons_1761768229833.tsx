...
export const LogoIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g stroke="#2D3748" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" fill="none">
      {/* Desk */}
      <path d="M10 170 H190" />
      
      {/* Body */}
      <path d="M50 170 Q50 140, 100 140 T150 170" fill="#FFF"/>
      <path d="M85 145 l15 15 l15-15" fill="#CBD5E0" strokeWidth="3"/>
      <path d="M90 152 l10 10 l10-10" fill="#E2E8F0" strokeWidth="3"/>

      {/* Head */}
      <rect x="60" y="60" width="80" height="80" rx="20" fill="#FFF"/>
      
      {/* Mask */}
      <path d="M65 110 C80 130, 120 130, 135 110 V120 C120 140, 80 140, 65 120 Z" fill="#60A5FA"/>
      <path d="M80 120 h15" stroke="#2D3748" strokeWidth="3"/>
      <path d="M105 120 h15" stroke="#2D3748" strokeWidth="3"/>
      
      {/* Eyes */}
      <circle cx="85" cy="95" r="8" fill="#2D3748" stroke="none"/>
      <circle cx="115" cy="95" r="8" fill="#2D3748" stroke="none"/>

      {/* Hat */}
      <path d="M60 70 Q50 40, 100 40 T140 70" fill="#FFF"/>
      <rect x="70" y="20" width="60" height="30" rx="10" fill="#FFF"/>

      {/* Cross on Hat */}
      <g fill="#60A5FA" stroke="none">
        <rect x="92" y="25" width="16" height="20" rx="2"/>
        <rect x="85" y="32" width="30" height="6" rx="2"/>
      </g>
      
      {/* Headphones */}
      <path d="M50 80 a 30 30 0 0 0 0 40" />
      <rect x="45" y="90" width="10" height="20" rx="5" fill="#2D3748" stroke="none"/>
      <path d="M150 80 a 30 30 0 0 1 0 40" />
      <rect x="145" y="90" width="10" height="20" rx="5" fill="#2D3748" stroke="none"/>
...
export const ConversationIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={IconProps.strokeWidth} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.537V17.5c0 .621-.504 1.125-1.125 1.125H9.75c-.621 0-1.125-.504-1.125-1.125V15.25c-1.072-.015-1.987-.936-1.987-2.003v-4.286c0-.97.616-1.813 1.5-2.097m1.5-3.351L12 4.25l1.5 1.5m-3 0l-1.5-1.5L12 4.25m6 6.75l-1.5-1.5-1.5 1.5m3 0l1.5 1.5 1.5-1.5M3 12l1.5-1.5 1.5 1.5m-3 0l-1.5 1.5L3 12" />
    </svg>
);
...
export const ToolsIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={IconProps.strokeWidth} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.343 3.94c.09-.542.56-.94 1.11-.94h1.093c.55 0 1.02.398 1.11.94l.149.894c.07.424.384.764.78.93.398.164.855.142 1.205-.108l.737-.527a1.125 1.125 0 011.45.12l.773.774c.39.389.44 1.002.12 1.45l-.527.737c-.25.35-.272.806-.108 1.204.165.397.505.71.93.78l.893.15c.543.09.94.56.94 1.11v1.093c0 .55-.397 1.02-.94 1.11l-.893.149c-.425.07-.765.383-.93.78-.164.398-.142.854.108 1.204l.527.738c.32.447.27.96-.12 1.45l-.773.773a1.125 1.125 0 01-1.449.12l-.738-.527c-.35-.25-.806-.272-1.203-.108-.397.165-.71.505-.78.93l-.15.894c-.09.542-.56.94-1.11.94h-1.093c-.55 0-1.02-.398-1.11-.94l-.149-.894c-.07-.424-.384-.764-.78-.93-.398-.164-.855-.142-1.205.108l-.737.527a1.125 1.125 0 01-1.45-.12l-.773-.774a1.125 1.125 0 01-.12-1.45l.527-.737c.25-.35.273-.806.108-1.204-.165-.397-.505-.71-.93-.78l-.894-.15c-.542-.09-.94-.56-.94-1.11v-1.093c0 .55.398-1.02.94-1.11l.894-.149c.424-.07.764-.383.93-.78.164-.398.142-.854-.108-1.204l-.527-.738a1.125 1.125 0 01.12-1.45l.773-.773a1.125 1.125 0 011.45-.12l.737.527c.35.25.807.272 1.204.108.397-.165.71-.505.78-.93l.15-.893z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
);
...
export const ResearchIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={IconProps.strokeWidth} stroke="currentColor" {...props}>
...
export const MusicIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={IconProps.strokeWidth} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 9l10.5-3m0 6.553v3.75a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 16.22a2.25 2.25 0 01-1.07-1.916V9.61a2.25 2.25 0 011.07-1.916l7.5-4.615a2.25 2.25 0 012.36 0L19.5 7.54z" />
    </svg>
);

export const LearningIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={IconProps.strokeWidth} stroke="currentColor" {...props}>
...
export const ConsultIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={IconProps.strokeWidth} stroke="currentColor" {...props}>
...
export const GoogleDriveIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path d="M7.71 5.43L12 12l4.29-6.57a.998.998 0 00-.858-1.43H8.57c-.433 0-.811.276-.96.684a.993.993 0 00.1.946z" />
        <path d="M15.43 18.57L12 12l-3.43 6.57a.998.998 0 00.858 1.43h6.14c.433 0 .811-.276.96-.684a.993.993 0 00-.1-.946z" />
        <path d="M3.43 14.57L7.71 7.43 3.43 7.43a.998.998 0 00-.858 1.43v4.28c0 .433.276.811.684.96a.993.993 0 00.946-.1z" />
        <path d="M20.57 9.43L16.29 16.57l4.28-2.14a.998.998 0 00.27-1.28.998.998 0 00-1.28-.27z" />
    </svg>
);
...
export const FirebaseIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path d="M3.4 18.1L12 2.9l2.1 3.5-7.7 13.5-3-1.8zm11.7-1.1L8.5 4.8l7.5 13.1-1.7 1.1z" />
        <path d="M12.4 19.3l4.6-2.6-2.5-4.3z" />
    </svg>
);

export const SupabaseIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path d="M12 2C6.477 2 2 6.477 2 12c0 1.95.552 3.766 1.5 5.33V7.5a8.5 8.5 0 0117 0v9.83c.948-1.565 1.5-3.38 1.5-5.33C22 6.477 17.523 2 12 2zm-1.5 14.5c0-.828.672-1.5 1.5-1.5s1.5.672 1.5 1.5S12.828 18 12 18s-1.5-.672-1.5-1.5z" />
    </svg>
);
...
export const FilePlusIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={IconProps.strokeWidth} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m.158 10.308l-3-3m0 0l-3 3m3-3v7.5" />
    </svg>
);

export const BugAntIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={IconProps.strokeWidth} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 018.638 5.214m8.132-2.586A3.375 3.375 0 0118 5.25v.75a3.375 3.375 0 01-3.375 3.375H9.375A3.375 3.375 0 016 6V5.25a3.375 3.375 0 012.25-3.132m8.132 2.586a3.375 3.375 0 00-2.25-3.132M8.638 2.628a3.375 3.375 0 012.25-3.132m0 0a3.375 3.375 0 013.75 0M4.5 9.75v1.5a3.375 3.375 0 003.375 3.375h3.75a3.375 3.375 0 003.375-3.375v-1.5M4.5 9.75h15" />
    </svg>
);
...
export const DocumentTextIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={IconProps.strokeWidth} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3h7.5m-1.5-9h1.5m-1.5 3h1.5m-4.5-3h1.5m-1.5 3h1.5M5.25 6h9m7.5 3v6a2.25 2.25 0 01-2.25 2.25H5.25a2.25 2.25 0 01-2.25-2.25V5.25a2.25 2.25 0 012.25-2.25h10.5a2.25 2.25 0 012.25 2.25v.75" />
    </svg>
);
...
export const DocumentArrowDownIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={IconProps.strokeWidth} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m-1.5 12.5l3-3m0 0l3 3m-3-3v6m-1.5-15H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
    </svg>
);
...
export const PaintBrushIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={IconProps.strokeWidth} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.47 2.118 2.25 2.25 0 01-2.47-2.118c0-.62.28-1.186.74-1.544a3 3 0 00-1.128-5.78c-.358-.086-.676-.248-.962-.462a3 3 0 00-4.48 2.518c0 .62.28 1.186.74 1.544a3 3 0 00-1.128-5.78c-.358-.086-.676-.248-.962-.462a3 3 0 00-4.48 2.518" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 15.75l-2.47-2.47a.75.75 0 00-1.06 0l-1.06 1.06a.75.75 0 01-1.06 0l-2.47-2.47a.75.75 0 00-1.06 0l-1.06 1.06a.75.75 0 01-1.06 0l-2.47-2.47a.75.75 0 00-1.06 0l-1.06 1.06a.75.75 0 01-1.06 0l-1.06-1.06a.75.75 0 00-1.06 0l-2.47 2.47m14.14 0l1.06-1.06a.75.75 0 000-1.06l-2.47-2.47a.75.75 0 00-1.06 0l-1.06 1.06a.75.75 0 000 1.06l2.47 2.47a.75.75 0 001.06 0zm-1.06-1.06l-2.47 2.47a.75.75 0 01-1.06 0l-1.06-1.06a.75.75 0 00-1.06 0l-2.47 2.47a.75.75 0 01-1.06 0l-1.06-1.06a.75.75 0 00-1.06 0l-2.47 2.47a.75.75 0 01-1.06 0" />
    </svg>
);
...
export const ChatBubbleLeftRightIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={IconProps.strokeWidth} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.537V17.5c0 .621-.504 1.125-1.125 1.125H9.75c-.621 0-1.125-.504-1.125-1.125V15.25c-1.072-.015-1.987-.936-1.987-2.003v-4.286c0-.97.616-1.813 1.5-2.097M3.75 14.25v-4.5a2.25 2.25 0 012.25-2.25h13.5a2.25 2.25 0 012.25 2.25v4.5" />
    </svg>
);

export const DeviceTabletIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={IconProps.strokeWidth} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25h.008v.008h-.008v-.008zm0 0v.008h.008v-.008h-.008zm-3.75 2.25H12a.75.75 0 000-1.5h.008a.75.75 0 000 1.5h-.008zM4.5 2.25h15A2.25 2.25 0 0121.75 4.5v15a2.25 2.25 0 01-2.25 2.25H4.5A2.25 2.25 0 012.25 19.5V4.5A2.25 2.25 0 014.5 2.25z" />
    </svg>
);

export const DevicePhoneMobileIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={IconProps.strokeWidth} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75A2.25 2.25 0 0015.75 1.5h-2.25m-3 0V3m3 0V3m0 0h.008v.008H12V3m-2.25 0h4.5M12 18.75h.008v.008H12v-.008z" />
    </svg>
);

export const FigmaIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M15.75 12c0 2.071-1.679 3.75-3.75 3.75V8.25c2.071 0 3.75 1.679 3.75 3.75z" />
        <path d="M8.25 12c0-2.071 1.679-3.75 3.75-3.75v7.5c-2.071 0-3.75-1.679-3.75-3.75z" />
        <path d="M8.25 4.5A3.75 3.75 0 004.5 8.25c0 2.071 1.679 3.75 3.75 3.75V4.5z" />
        <path d="M15.75 4.5A3.75 3.75 0 0119.5 8.25c0 2.071-1.679 3.75-3.75 3.75V4.5z" />
        <path d="M8.25 15.75A3.75 3.75 0 004.5 19.5c0 2.071 1.679 3.75 3.75 3.75v-7.5z" />
    </svg>
);
